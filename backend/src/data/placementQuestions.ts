// Adaptive-ish placement bank: multiple-choice items of increasing difficulty,
// plus one open writing prompt. Each item has a Hebrew translation (promptHe) and
// a short Hebrew explanation (explanationHe) so absolute beginners can understand
// the question and learn from mistakes. `answerIndex` is kept server-side only.
